...
class ReferentielMusical:
    ...
    def _extract_genres(self):
        ...
        print(f"✓ Extrait {len(self.genres)} genres musicaux")
    ...
    def _extract_artistes(self):
        ...
        print(f"✓ Extrait {len(self.artistes)} artistes")
    ...
    def _build_moods(self):
        ...
        print(f"✓ Construit {len(self.moods)} moods")
    ...
    def _build_ambiances(self):
        ...
        print(f"✓ Construit {len(self.ambiances)} ambiances")
    ...
    def _build_playlists(self):
        ...
        print(f"✓ Construit {len(self.playlists)} playlists")
    ...
    def _save_referentiel(self):
        ...
        print(f"✓ Référentiel sauvegardé dans {output_path}")
...
if __name__ == "__main__":
    print("Construction du référentiel musical...")
    ref = ReferentielMusical()
    print("\n✓ Référentiel construit avec succès!")
    print(f"  - {ref.metadata['total_genres']} genres")
    print(f"  - {ref.metadata['total_artistes']} artistes")
    print(f"  - {ref.metadata['total_moods']} moods")
    print(f"  - {ref.metadata['total_ambiances']} ambiances")
    print(f"  - {ref.metadata['total_playlists']} playlists")
